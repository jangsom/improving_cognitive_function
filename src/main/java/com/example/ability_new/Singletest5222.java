...
public class Singletest5222 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_singletest5222);
    }
        ...
        else
        {
            ...
            if(num == 6)
            {
                ...
                new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
                    @Override
                    public void run() {
                        AlertDialog.Builder builder = new AlertDialog.Builder(Singletest5222.this);
                        AlertDialog alertDialog = builder.create();
                        alertDialog.show();
                        Intent intent = new Intent(Singletest5222.this,Singletest5223.class);
    ...
    public void onClick2(View view) {
        ...
        builder.setPositiveButton("예", new DialogInterface.OnClickListener(){
            ...
            {
                Intent intent = new Intent(Singletest5222.this,Questionsingle.class);
