...
public class Singletest6283 extends AppCompatActivity implements View.OnClickListener{
    int count1=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_singletest6283);
    ...
    public void onClick(View view) {
        ...
        if(count1==1){
            ...
            new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
                @Override
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Singletest6283.this);
                    AlertDialog alertDialog = builder.create();
                    alertDialog.show();
                    Intent intent = new Intent(Singletest6283.this,Singletest6284.class);
