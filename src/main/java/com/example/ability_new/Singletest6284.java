...
public class Singletest6284 extends AppCompatActivity implements View.OnClickListener{
    int count1=0,count2=0,count3=0;
    ImageView view1,circle5,circle6,circle7;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_singletest6284);
        ...
        circle6 = (ImageView) findViewById(R.id.imageView72);
        circle6.setOnClickListener((View.OnClickListener) this);
        circle7 = (ImageView) findViewById(R.id.imageView73);
    ...
    public void onClick(View view) {
        ...
        if(count1==1&&count2==1&&count3==1){
            ...
            new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
                @Override
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Singletest6284.this);
                    AlertDialog alertDialog = builder.create();
                    alertDialog.show();
                    Intent intent = new Intent(Singletest6284.this,Singletest6285.class);
