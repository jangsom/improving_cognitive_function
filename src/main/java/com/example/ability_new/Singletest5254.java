...
public class Singletest5254 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_singletest5254);
    }
        ...
        else
        {
            ...
            if (num == 5) {
                ...
                new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
                    @Override
                    public void run() {
                        AlertDialog.Builder builder = new AlertDialog.Builder(Singletest5254.this);
                        AlertDialog alertDialog = builder.create();
                        alertDialog.show();
                        Intent intent = new Intent(Singletest5254.this, Part5CorrectGrape.class);
    ...
    public void onClick1(View view) {
        Intent intent = new Intent(Singletest5254.this,Singletest6281.class);
        startActivity(intent);
    }
}