...
public class Singletest4181check extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_singletest4181check);
    }
    public void onClick99 (View view){
        ...
        new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
            @Override
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(Singletest4181check.this);
                AlertDialog alertDialog = builder.create();
                alertDialog.show();
                Intent intent = new Intent(Singletest4181check.this,Singletest4182.class);
    ...
    public void onClick2(View view) {
        ...
        builder.setPositiveButton("예", new DialogInterface.OnClickListener(){
            ...
            {
                Intent intent = new Intent(Singletest4181check.this,Questionsingle.class);
