...
public class Singletest6285 extends AppCompatActivity implements View.OnClickListener {
    int count1=0,count2=0,count3=0,count4=0,count5=0;
    ImageView view1,circle5,circle6,circle7,circle8,circle9;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_singletest6285);
        ...
        circle9.setOnClickListener((View.OnClickListener) this);
    }
    ...
    public void onClick(View view) {
        ...
        if(count1==1&&count2==1&&count3==1&&count4==1&&count5==1){
            ...
            new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
                @Override
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Singletest6285.this);
                    AlertDialog alertDialog = builder.create();
                    alertDialog.show();
                    Intent intent = new Intent(Singletest6285.this,Singletest6286.class);
