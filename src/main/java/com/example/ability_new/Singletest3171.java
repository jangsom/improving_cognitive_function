...
public class Singletest3171 extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_singletest3171);
        //5가 별 6이 빈칸(온클릭2)
    }
            ...
            if(f==0){
                if (count1 == 1 && count2 == 1 && count3 == 1 && count4 == 1) {
                    ...
                    new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
                        @Override
                        public void run() {
                            AlertDialog.Builder builder = new AlertDialog.Builder(Singletest3171.this);
                            AlertDialog alertDialog = builder.create();
                            alertDialog.show();
                            Intent intent = new Intent(Singletest3171.this, Singletest3172.class);
    ...
    public void onClick2(View view) {
        ...
        builder.setPositiveButton("예", new DialogInterface.OnClickListener(){
            ...
            {
                Intent intent = new Intent(Singletest3171.this,Questionsingle.class);
