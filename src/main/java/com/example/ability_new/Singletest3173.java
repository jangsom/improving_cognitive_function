...
public class Singletest3173 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_singletest3173);
    }
    ...
    public void onClick2(View view) {
        ...
        builder.setPositiveButton("예", new DialogInterface.OnClickListener(){
            ...
            {
                Intent intent = new Intent(Singletest3173.this,Questionsingle.class);
    ...
    public void onClick1(View view) {
        Intent intent = new Intent(Singletest3173.this,Singletest3174.class);
            ...
            if(f==0){
                if (count1 == 1 && count2 == 1 && count3 == 1 && count4 == 1) {
                    ...
                    new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
                        @Override
                        public void run() {
                            AlertDialog.Builder builder = new AlertDialog.Builder(Singletest3173.this);
                            AlertDialog alertDialog = builder.create();
                            alertDialog.show();
                            Intent intent = new Intent(Singletest3173.this, Singletest3174.class);
                            startActivity(intent);
