...
public class Singletest5221 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_singletest5221);
    }
        ...
        else
        {
            ...
            if(num == 5)
            {
                ...
                new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
                    @Override
                    public void run() {
                        AlertDialog.Builder builder = new AlertDialog.Builder(Singletest5221.this);
                        AlertDialog alertDialog = builder.create();
                        alertDialog.show();
                        Intent intent = new Intent(Singletest5221.this,Singletest5222.class);
    ...
    public void onClick2(View view) {
        ...
        builder.setPositiveButton("예", new DialogInterface.OnClickListener(){
            ...
            {
                Intent intent = new Intent(Singletest5221.this,Questionsingle.class);
