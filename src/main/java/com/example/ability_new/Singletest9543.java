...
public class Singletest9543 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_singletest9543);
    }
    ...
    public void onClick(View view) {
        ...
        String getEdit3 = editText4.getText().toString();
        ...
        else
        {
            ...
            if(num1==41&&num3==34&&num4==37)
            {
                CorrectDatabase.getInstance().Corrects.IncreaseCorrectCount("9", new Date());
                ...
                new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
                    @Override
                    public void run() {
                        AlertDialog.Builder builder = new AlertDialog.Builder(Singletest9543.this);
                        AlertDialog alertDialog = builder.create();
                        alertDialog.show();
                        Intent intent = new Intent(Singletest9543.this,Part9CorrectGrpae.class);
    ...
    public void onClick1(View view) {
        Intent intent = new Intent(Singletest9543.this,Singletest10551.class);
        startActivity(intent);
    }
}