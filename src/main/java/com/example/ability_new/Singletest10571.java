...
public class Singletest10571 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_singletest10571);
    }
    ...
    public void onClick(View view) {
        ...
        else
        {
            ...
            if(num1==3&&num2==2&&num3==1&&num4==3&&num5==2&&num6==1){
                ...
                new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
                    @Override
                    public void run() {
                        AlertDialog.Builder builder = new AlertDialog.Builder(Singletest10571.this);
                        AlertDialog alertDialog = builder.create();
                        alertDialog.show();
                        Intent intent = new Intent(Singletest10571.this,Singletest10572.class);
    ...
    public void onClick1(View view) {
        Intent intent = new Intent(Singletest10571.this,Singletest10581.class);
        startActivity(intent);
    }
}