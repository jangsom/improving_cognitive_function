...
public class Singletest6321 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_singletest6321);
    ...
    public void onClick(View view) {
        ...
        if(count1==1&&count2==1&&count3==1&&count4==1){
            ...
            new Handler().postDelayed(new Runnable() {  // 5초뒤에 AlertDialog 실행
                @Override
                public void run() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Singletest6321.this);
                    AlertDialog alertDialog = builder.create();
                    alertDialog.show();
                    Intent intent = new Intent(Singletest6321.this,Part6CorrectGrape.class);
    ...
    public void onClick1(View view) {
        Intent intent = new Intent(Singletest6321.this,Singletest7352.class);
        startActivity(intent);
    }
}